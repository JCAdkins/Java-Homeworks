...
public class Employee {
    ...
    private double ytdgrossEarning;
    private double ytdfedTaxes;
    private double ytdSSTaxes;
    private double ytdmedTaxes;
    ...
    public String displayEmployee(){                            /* Method that returns a String containing all pertinent information regarding Employee */
