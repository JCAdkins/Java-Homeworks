...
Date: 5/5/18
Abstract: Creates a class that can open, read, write, append and close Earnings files.
 */
...
public class FileEarnings {
    public Earnings newEarnings = new Earnings();             //all variables needed for the class
    ...
    public FileEarnings(){            //paysum constructor
        
    }
    
    public FileEarnings(String filename){         //constructor with params
...
return succeeded;
    ...
    public boolean writeRecord(){               //method to write to the file
        boolean succeeded = false;
        try{
            bufferedWriter.write(newEarnings.dataWriter());
