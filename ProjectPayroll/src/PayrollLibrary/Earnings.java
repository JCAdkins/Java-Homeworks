...
public class Earnings extends PaySum implements DisplayObject, Parser {
    ...
    public String dataWriter(){
        return depNumber + "," + super.getempNumber() + "," + super.getregHours() + "," + super.getovertimeHours() + "," + super.getshift2Hours() + "," + super.getshift3Hours() + "," + super.getweekendHours() + "," + regPay + "," + overtimePay + "," + shift2Pay + "," + shift3Pay + "," + weekendPay + "," + grossPay + "," + fedWithholding + "," + ssWithholding 
                + "," + medWithholding + "," + stateWithholding + "," + volDeductions + "," + netPay + "," + checkDate + "," + checkNumber;
    }
    ...
    public void parse(String input) {                   //will parse a comma delimited input string
       ...
       setcheckNumber(Float.parseFloat(splitFields[20]));
    }
