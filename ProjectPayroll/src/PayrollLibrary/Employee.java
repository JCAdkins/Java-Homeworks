...
public class Employee implements DisplayObject, Parser {
    ...
    public float getytdgrossEarning(){
        return ytdgrossEarning;
    }
    public float getytdfedTaxes(){
        return ytdfedTaxes;
    }
    public float getytdSSTaxes(){
        return ytdSSTaxes;
    }
    public float getytdmedTaxes(){
        return ytdmedTaxes;
    }
    public float getytdstateTaxes(){
