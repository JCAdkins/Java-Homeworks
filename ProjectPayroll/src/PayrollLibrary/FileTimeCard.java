...
Date: 5/5/18
Abstract: Creates a class that can open, read, write, append and close TimeCard files.
 */
...
public class FileTimeCard {
    public TimeCard newTimeCard = new TimeCard();           //create all variables needed for class
    ...
    public FileTimeCard(){                  //constructor
        
    }
    
    public FileTimeCard(String filename){       //constructor with params
...
return succeeded;
    ...
    public boolean writeRecord(){           //method to write to the file
        boolean succeeded = false;
        try{
            bufferedWriter.write(newTimeCard.dataWriter());
