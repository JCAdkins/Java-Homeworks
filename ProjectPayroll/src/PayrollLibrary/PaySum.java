...
Date: 5/5/18
Abstract: Creates the class that will handle the payroll summary for employees
 */
...
public class PaySum implements DisplayObject, Parser {     
    ...
    public String dataWriter(){
        return empNumber + "," + regHours + "," + overtimeHours + "," + shift2Hours + "," + shift3Hours + "," + weekendHours;
    }
