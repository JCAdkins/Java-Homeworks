...
public class Student implements Comparable<Student> {
     ...
     */
    @Override
    //May be a never ending recursive call
     ...
     * @param pScore is the score of the exam
     *
     ...
     *
     * @param pNum is the index into the list of homeworks, where 0 is the index of the first hw score.
     * @param pScore is the score of the homework
     *
