...
public class GradebookReader  {
     ...
     * later when readRoster() is called from Main.run().
     *
     * @throws FileNotFoundException if file is found throw exception
     *
    ...
    private Roster readRoster() {
        ...
        while (mIn.hasNext()) {
            ...
            Student student = new proj3.Student(firstName, lastName);
            readExam(student);
