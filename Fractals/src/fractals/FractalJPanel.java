...
public class FractalJPanel extends JPanel
{
   ...
   private static final int WIDTH = 500;  // defines width of JPanel
   private static final int HEIGHT = 500; // defines height of JPanel
   ...
   public void paintComponent(Graphics g)
   {
      ...
      g.setColor(color);
      drawFractal(level, 50, 50, 390, 300, g); 
   } 
