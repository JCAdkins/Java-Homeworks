...
public class Board extends JPanel { 
    ...
    private String level = Sokoban.Wevel.getlevel();
    ...
    public void buildWorld(Graphics g) {
        ...
        for (int i = 0; i < world.size(); i++) {
            ...
            if (completed) {
                ...
                Sokoban.Wevel.setLevel(Sokoban.Wevel.getintLevel()+1);
                level = Sokoban.Wevel.getlevel();
                setSize(getBoardWidth() + OFFSET,
                getBoardHeight() + 2*OFFSET);
                restartLevel();
            }
